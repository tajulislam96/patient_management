...
echo "<script type='text/javascript'> document.location = 'patient_info.php'; </script>";
} else{
...
<div class="signup-form">
    <form  method="post" class="needs-validation" novalidate>
		...
		<div class="form-group">
			<button type="submit" class="btn btn-primary btn-block btn-lg" id="cc" name="login">Log in </button>
		</div>	
    </form>
	<div class="text-center small">Only Registrated Patient Login</div>
	<div class="text-center small">পাসওয়ার্ড ভুলে গেলে আমাদের সঙ্গে যোগাযোগ করার জন্য বলা হলো-ধন্যবাদ</div>
	<div class="text-center small">Go to Home page <a href="http://localhost/patient_management/">Home</a></div>
</div>
<script>
