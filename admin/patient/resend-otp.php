...
if (isset($_POST['resend'])) {
    ...
    $ret = "SELECT id,isEmailVerify,userName FROM tblusers where (emailId=:uemail)";
    ...
    if ($queryt->rowCount() > 0) {
        ...
        if ($verifystatus == '1') {
            ...
            try {
                ...
                $mail->Body    = "<html></body><div><div>Dear $name,</div></br></br><div style='padding-top:8px;'>Thank you for registering at ICON MEDICAL HOSPITAL,Trishal,Mymensingh. Your new OTP for Account Verification is $otp</div><div></div></body></html>";
